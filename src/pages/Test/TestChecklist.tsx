  ...
  const scamEmails: Email[] = [
    {
      ...
      content: (
        <>
          <p>Dear Customer,</p>
          <p className="mt-2">
            We noticed your Office 365 subscription has expired. To continue
            using your services without interruption, please update your payment
            details.
          </p>
        </>
      ),
    ...
    },
    {
      ...
      subject:
        "Subject: 🎁 You've won a free 1-year Spotify Premium membership!",
      content: (
        <>
          <p>Congratulations!</p>
          <p className="mt-2">
    ...
    },
    {
      ...
      content: (
        <>
          <p>Dear Customer,</p>
          <p className="mt-2">
            You have been randomly selected to receive a free iPhone 15! Click
            the button below to claim your prize before it's too late.
          </p>
        </>
      ),
      ...
      content: (
        <>
          ...
          <p className="mt-2">
            ...
            account. To restore access, please confirm your identity by
            providing your login details and credit card number.
          </p>
        </>
      ),
    ...
    },
    {
      ...
      content: (
        <>
          <p>Hello,</p>
          <p className="mt-2">
            We have updated our Privacy Policy, effective May 1, 2025. You do
            not need to take any action, but we encourage you to review the
            updates.
          </p>
        </>
      ),
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className="mt-2">
            Your payment for Spotify Premium has been processed successfully.
      ...
      content: (
        <>
          ...
          <p className="mt-2">
            ...
            confirmed. You can check your itinerary and manage your booking
            below.
          </p>
        </>
      ),
