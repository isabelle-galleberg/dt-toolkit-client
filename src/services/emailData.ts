...
export const legitEmails: Email[] = [
  {
    ...
    greeting: `Hello`,
    text: 'Your order #5678-1234 has been shipped. You can track it through your Amazon account.',
  ...
  },
  {
    ...
    greeting: 'Hello',
    text: "Your TikTok verification code is: 847293. Enter this code to complete your login. If you didn't request this, you can ignore this email.",
